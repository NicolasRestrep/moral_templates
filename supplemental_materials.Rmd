...
color_scheme_set("red")
p3 <- mcmc_intervals(b7, regex_pars = "^b_", prob_outer = 0.95)  + 
...
```{r}
color_scheme_set("red")
p4 <- mcmc_intervals(b8, regex_pars = "^b_", prob_outer = 0.95)  + 
  labs(title = "Count of negative moral words", 
...
```{r}
color_scheme_set("red")
p5 <- mcmc_intervals(b9, regex_pars = "^b_", prob_outer = 0.95)  + 
  labs(title = "Count of negative moral words", 
