...
triplets <- read_csv("~/Documents/moral_templates/Data/bb_triplets_dataset.csv")
glimpse(triplets)
...
dictionary <- read_csv("~/Documents/moral_templates/Data/FullSurveyorUSMeans.csv")
...
write_csv(d_filtered, "~/Documents/moral_templates/Data/bb_already_known.csv", col_names = TRUE)
